...
$pdf->Cell(23,0.7,'Laporan Data Penjualan Kue',0,0,'C');
$pdf->ln(1);
...
$query=mysqli_query($koneksi,"select * from penjualan where tanggal=" . $tanggal);
...
$q=mysqli_query($koneksi,"select sum(total_harga) as total from penjualan where tanggal=".$tanggal);
...
$qu=mysqli_query($koneksi,"select sum(laba) as total_laba from penjualan where tanggal=".$tanggal);
