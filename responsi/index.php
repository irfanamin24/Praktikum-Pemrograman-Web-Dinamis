	...
	<div class="container">
		...
		if(isset($_GET['pesan'])){
			if($_GET['pesan'] == "gagal"){
				...
				echo "<div style='margin-bottom:-55px' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  Login Gagal !! Captcha Salah !!</div>";
			}
		}
		?>
		<div class="panel panel-default">
			<form action="x_login.php" method="post">
				<div class="col-md-4 col-md-offset-4 kotak">
					...
					<div class="input-group">
						<span class="input-group-addon"><img src='admin/captcha.php'/></span>
